...
func SKNTD_assert_uint256_difference{
...
func SKNTD_assert_uint256_eq{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        a : Uint256, b : Uint256):
...
func SKNTD_assert_uint256_not_zero{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        a : Uint256):
...
func SKNTD_assert_uint256_strictly_positive{
